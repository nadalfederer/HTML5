/**
 * Created by vladimir on 02.11.15.
 */

function  pie(id, o){
    this.includeLabel=false;
    if(o.includeLabel === undefined){
        this.includeLabel=false;
    }
    else{
        this.includeLabel= o.includeLabel;
    }
    this.data= o.data ? o.data :[30, 70, 45, 65, 20, 130];
    this.labels= o.labels ? o.labels : ["First", "Second", "Third", "Fourth"];
...
pie.prototype={
    ...
    draw: function() {
        ...
        for (var i = 0; i < this.data.length; i++) {
            this.drawSegment(this.canvas, context, i, this.data[i], false, this.includeLabel);
        }
    },
